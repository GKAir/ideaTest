				...
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/list" method="get">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="customerName" value="${custName}" name="customer.custName">
						</div>
						<div class="form-group">
							<label for="customerFrom">客户来源</label> 
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="customer.custSource">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="custIndustry"  name="customer.custIndustry">
								<option value="">--请选择--</option>
						...
						<div class="form-group">
							...
							<select	class="form-control" id="custLevel" name="customer.custLevel">
								<option value="">--请选择--</option>
